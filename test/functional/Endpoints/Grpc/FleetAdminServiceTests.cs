...
public sealed class FleetAdminServiceTests
{
    ...
    [Test]
    public async Task ListUsers_BillingDisabled_ThrowsUnimplemented()
    {
        ...
        try
        {
            await client.ListUsersAsync(
                new ListUsersRequest { Page = 1, PageSize = 10 }, Headers("test-key"));
        }
        ...
        await Assert.That(exception!.StatusCode).IsEqualTo(StatusCode.Unimplemented);
    }
