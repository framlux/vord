...
/// <summary>
/// Returns historical memory utilization data for a machine.
/// </summary>
public sealed class MemoryHistoryEndpoint : EndpointWithoutRequest
{
    private readonly IMachineStateRepository _stateRepo;
    private readonly HistoryRequestValidator _validator;

    /// <summary>
    /// Creates a new instance of the <see cref="MemoryHistoryEndpoint"/> class.
    /// </summary>
    public MemoryHistoryEndpoint(
