...
public sealed class RedisMachinePingService : IMachinePingService
{
    ...
    public RedisMachinePingService(IConnectionMultiplexer redis, ILogger<RedisMachinePingService> logger)
    {
    ...
    public async Task RecordPingAsync(long machineId)
    {
        await RetryHelper.ExecuteWithRetryAsync(async () =>
        {
            ...
            double cutoffMs = DateTimeOffset.UtcNow.Subtract(RetentionWindow).ToUnixTimeMilliseconds();
